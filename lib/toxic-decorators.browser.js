...
var getOwnPropertyDescriptors = isFunction(Object.getOwnPropertyDescriptors) ? Object.getOwnPropertyDescriptors : function (obj) {
...
function compressMultipleDecorators() {
  for (var _len4 = arguments.length, fns = Array(_len4), _key5 = 0; _key5 < _len4; _key5++) {
...
function autobindClass() {
  ...
  return function (Klass) {
    ...
    for (var i = 0, len = keys.length; i < len; i++) {
      ...
      // $FlowFixMe: not support symbol yet
      defineProperty$2(prototype, key, autobind(prototype, key, desc));
    }
  };
}
...
var Hooks = function () {
  ...
  createClass(Hooks, [{
    ...
    value: function deepObeserve(obj, key, context) {
      ...
      defineProperty$7(obj, key, compressMultipleDecorators(accessor({
        set: function set$$1(value) {
...
function watch(keyOrFn) {
  ...
  return function (obj, prop, descriptor) {
    var handler = isString(keyOrFn) ? function (newVal, oldVal) {
      var target = isPrimitive(other) ? obj : other;
...
function applyDecorators(Class, props) {
  ...
  for (var key in props) {
    ...
    var handler = void 0;
    try {
      handler = compressMultipleDecorators.apply(undefined, toConsumableArray(decorators));
    } catch (err) {
