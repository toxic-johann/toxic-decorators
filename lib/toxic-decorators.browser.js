...
function setAlias(root, prop, descriptor, obj, key) {
  if (getOwnPropertyDescriptor$1(obj, key) !== undefined) {
...
function applyDecorators(Class, props) {
  ...
  for (var key in props) {
    ...
    for (var _i = 0, l = decorators.length; _i < l; _i++) {
      ...
      defineProperty$5(prototype, key, decorator(prototype, key, descriptor));
    }
  }
  return Class;
}
