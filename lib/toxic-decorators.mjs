...
import { bind, isArray, isBoolean, isFunction, isNumber, isObject, isPrimitive, isPromise, isString, isVoid } from 'toxic-predicate-functions';
import * as toxicPredicateFunctions from 'toxic-predicate-functions';
import { bind as bind$1 } from 'toxic-utils';
...
export { accessor, before, after, readonly, alias, autobind, frozen, initialize, waituntil, lazyInit, lock, watch, nonextendable, enumerable, nonenumerable, nonconfigurable, string as initString, boolean as initBoolean, array as initArray, number as initNumber, string$1 as alwaysString, boolean$1 as alwaysBoolean, array$1 as alwaysArray, number$1 as alwaysNumber, autobindClass, applyDecorators, getOwnKeys, getOwnPropertyDescriptors };
