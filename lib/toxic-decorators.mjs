...
function isAccessorDescriptor(desc) {
  return (isFunction(desc.get) || isFunction(desc.set)) && isBoolean(desc.configurable) && isBoolean(desc.enumerable) && desc.writable === undefined;
}
/**
...
function isInitializerDescriptor(desc) {
  return isFunction(desc.initializer) && isBoolean(desc.configurable) && isBoolean(desc.enumerable) && isBoolean(desc.writable);
}
/**
 ...
 */
function autobind(obj, prop, _ref) {
  var fn = _ref.value,
      configurable = _ref.configurable,
      enumerable = _ref.enumerable,
      writable = _ref.writable;
...
function waituntil(fn, other) {
  ...
  return function (obj, prop, _ref) {
    ...
    if (isString(fn)) {
      ...
      var descriptor = getOwnPropertyDescriptor$1(target, fn);
      /**
      ...
      var desc = isDescriptor(descriptor) ? accessor({ set: set })(target, fn, descriptor) : accessor({ set: set })(target, fn, {
        value: undefined,
        configurable: true,
        enumerable: true,
        writable: true
      });
      defineProperty$2(target, fn, desc);
    }
    return {
      value: function value() {
        ...
        if (isString(fn)) {
          ...
          if (this[fn]) return boundFn.apply(undefined, args);
          // else we just put it into waiting queue
          var cb = function cb() {
            return boundFn.apply(undefined, args);
          };
          waitingQueue.push(cb);
          return;
        }
        // $FlowFixMe: we have change promise into function
        var runnable = bind(fn, this).apply(undefined, args);
...
export { accessor, before, readonly, alias, autobind, frozen, initialize, waituntil, string as initString, boolean as initBoolean, array as initArray, number as initNumber, array$1 as alwaysArray, boolean$1 as alwaysBoolean, number$1 as alwaysNumber, string$1 as alwaysString };
