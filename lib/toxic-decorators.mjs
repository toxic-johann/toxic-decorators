...
function waituntil(fn) {
  ...
  return function (obj, prop, _ref) {
    ...
    if (isString(fn)) {
      var descriptor = getOwnPropertyDescriptor$1(obj, fn);
      /**
       ...
       */
      var desc = isDescriptor(descriptor) ? accessor({ set: set })(obj, fn, descriptor) : accessor({ set: set })(obj, fn, {
        value: undefined,
        configurable: true,
        enumerable: true,
        writable: true
      });
      defineProperty$2(obj, fn, desc);
    }
    return {
