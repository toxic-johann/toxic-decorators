...
import { isArray, isBoolean, isFunction, isNumber, isObject, isPrimitive, isPromise, isString, isVoid } from 'toxic-predicate-functions';
...
export { accessor, before, after, readonly, alias, autobind, frozen, initialize, waituntil, lazyInit, lock, watch, nonextendable, runnable, enumerable, nonenumerable, nonconfigurable as configurable, nonconfigurable$1 as nonconfigurable, string as initString, boolean as initBoolean, array as initArray, number as initNumber, string$1 as alwaysString, boolean$1 as alwaysBoolean, array$1 as alwaysArray, number$1 as alwaysNumber, autobindClass, before$1 as beforeClass, after$1 as afterClass, runnable$1 as runnableClass, waituntil$1 as waituntilClass, applyDecorators, classify, getOwnKeys, getOwnPropertyDescriptors, isDescriptor, isAccessorDescriptor, isInitializerDescriptor, isDataDescriptor };
