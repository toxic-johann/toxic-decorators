  ...
  return function (obj, prop, _ref) {
    ...
    var canIRun = isPromise(key) ? function () {
      ...
      if (!binded) {
        ...
        var descriptor = getOwnPropertyDescriptor$1(target, prop);
        /**
        ...
        var desc = isDescriptor(descriptor) ? accessor({ set: set })(target, prop, descriptor) : accessor({ set: set })(target, prop, {
          value: undefined,
          configurable: true,
          enumerable: true,
          writable: true
    ...
    return {
      value: function value() {
        ...
        if (isPromise(runnable)) {
          ...
          return binded && new _Promise(function (resolve) {
            var cb = function cb() {
