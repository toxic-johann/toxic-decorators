 ...
 * Released under MIT
 * Built ad Sun Oct 09 2022 12:57:48 GMT+0800 (China Standard Time)
 */
 ...
 * @returns {Function} Returns `func`.
 */
var baseSetToString = !defineProperty$8 ? identity : function(func, string) {
  return defineProperty$8(func, 'toString', {
    'configurable': true,
    'enumerable': false,
...
function getOwnKeysFn() {
  ...
  return isFunction(getOwnPropertySymbols) ? function (obj) {
    return [].concat(_toConsumableArray__default["default"](getOwnPropertySymbols(obj)), _toConsumableArray__default["default"](getOwnPropertyNames(obj)));
  } : getOwnPropertyNames;
}
...
function compressMultipleDecorators() {
  ...
  fns.forEach(function (fn) {
    if (!isFunction(fn)) {
      throw new TypeError("Decorators must be a function, but not \"".concat(fn, "\" in ").concat(_typeof__default["default"](fn)));
    }
  });
  ...
  return function (obj, prop, descriptor) {
    ...
    var handler = function handler() {
      ...
      var paras = fns.reduce(function (paras, fn) {
        var result = bind$1(fn, _this).apply(void 0, _toConsumableArray__default["default"](paras));
        return result === undefined ? paras : isArray$1(result) ? result : [result];
      }, args);
      return bind$1(fn, this).apply(void 0, _toConsumableArray__default["default"](paras));
    };
  ...
  return function (obj, prop, descriptor) {
    ...
    function getTargetAndName(other, obj, key) {
      ...
      var _keys$slice = keys.slice(-1),
          _keys$slice2 = _slicedToArray__default["default"](_keys$slice, 1),
          name = _keys$slice2[0];
...
function autobind$1(obj, prop, descriptor) {
  ...
  if (!isFunction(fn)) {
    throw new TypeError("@autobind can only be used on functions, not \"".concat(fn, "\" in ").concat(_typeof__default["default"](fn), " on property \"").concat(prop, "\""));
  }
...
function waituntil$1(key) {
  ...
  if (!isFunction(key) && !toxicPredicateFunctions.isPromise(key) && !isString(key)) {
...
function applyDecorators(Class, props) {
  ...
  for (var key in props) {
    ...
    try {
      handler = compressMultipleDecorators.apply(void 0, _toConsumableArray__default["default"](decorators));
    } catch (err) {
      if (process.env.NODE_ENV !== 'production') {
...
function deepProxy(value, hook, _ref) {
  ...
  var operateProps = (_operateProps = {}, _defineProperty__default["default"](_operateProps, operationPrefix + 'set', [initialize(function () {
    return function (property, val) {
      proxyValue[property] = val;
    };
  }), nonenumerable]), _defineProperty__default["default"](_operateProps, operationPrefix + 'del', [initialize(function () {
...
function deepObserve(value, hook, _ref2) {
  ...
  var operateProps = (_operateProps2 = {}, _defineProperty__default["default"](_operateProps2, operationPrefix + 'set', [initialize(function (method) {
    return function (property, val) {
  ...
  }), nonenumerable]), _defineProperty__default["default"](_operateProps2, operationPrefix + 'del', [initialize(function (method) {
    return function (property) {
      if (isFunction(method)) {
